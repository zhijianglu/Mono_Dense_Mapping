...
//  cout<<"------------------------------"<<endl;
//  cout<<"image stamp:"<<image_input->header.stamp.sec<<"."<<image_input->header.stamp.nsec<<endl;
//  cout<<"pose  stamp:"<<pose_input->header.stamp.sec<<"."<<pose_input->header.stamp.nsec<<endl;
//  cout<<"------------------------------"<<endl;
...
//  T_world_curr.data();
  ...
  if(has_result){
    if(RECORD_POSE){
      string time_stamp = to_string(image_input->header.stamp.toSec());
        pose_out << time_stamp << " " <<
                 pose_input->pose.position.x << " " <<
                 pose_input->pose.position.y << " " <<
                 pose_input->pose.position.z << " " <<
                 ...
                 pose_input->pose.orientation.y << " " <<
                 pose_input->pose.orientation.z << " " <<
                 pose_input->pose.orientation.w << " " << endl; //平移向量
    }
